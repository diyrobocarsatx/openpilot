...
_FINGERPRINTS = {
  ...
  #TOYOTA.KIA: { #JP
   # 112L: 8, 113L: 8, 114L: 8, 115L: 8, 128L: 8, 129L: 8, 130L: 8, 131L: 8, 144L: 8, 145L: 8, 146L: 8, 147L: 8, 175L: 8, #JP
 # }, #JP
}
...
#    f.write('\nopenpilot -> common -> fingerprints.py -> is_valid_for_fingerprint method\n') #JP
#    f.write('message is '+ str(msg) + '\n') #JP
#    f.write('car finger print is ' + str(car_fingerprint)) #JP

  print '\n> openpilot/common/fingerprints.py is_valid_for_fingerprint(msg, car_fingerprint)\n' #JP
  print '  > msg = ', msg #JP
  print '  > car_fingerprint = ', car_fingerprint #JP
...
def eliminate_incompatible_cars(msg, candidate_cars):
  ...
  compatible_cars = []
#  with open('mgrTT', 'a+') as f: #JP
#    f.write('\nopenpilot -> common -> fingerprints.py -> eliminate_incompatible_cars method\n') #JP
#    f.write('message is '+ str(msg) + '\n') #JP
  print '\nopenpilot/common/fingerprints.py eliminate_incompatible_cars(msg, candidate_cars) return compatible_cars\n' #JP
  print 'msg = ', msg, '\n' #JP
  for car_name in candidate_cars:
    ...
    for fingerprint in car_fingerprints:
      if is_valid_for_fingerprint(msg, fingerprint):
        ...
        break
    print 'compatible_cars = ', compatible_cars, '\n' #JP
...
def all_known_cars():
  ...
  print '\n> all_known_cars() openpilot/common/fingerprints.py' #JP
  print '  > # Returns a list of all known car strings (openpilot comment) all_known_cars()' #JP
  print '  > [fingerprints.py all_known_cars()] _Fingerprints.keys() = ', _FINGERPRINTS.keys(), '\n' #JP
